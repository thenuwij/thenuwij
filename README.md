...
My broader project work span embedded systems and FPGA development, computer vision and machine learning, full-stack and backend engineering, and AI agent architecture. I've worked on projects ranging from a real-time FPGA audio pipeline using VHDL and AXI DMA to a personal finance dashboard with an AI agent that can autonomously query your financial data, log transactions and analyse spending patterns.
